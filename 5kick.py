...
ki = LINE('Eu0Jr0Z4ciSm78y0G1Ld.MJjB5RM02td4rFyvdkvFtq.ATCIOiW3LVIB6uht9Os/2bo7F4eHM97ZbxhWmy7RCRg=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

kk = LINE('EupV0e0bHm84JhBKs1d3.FXP8F/ZJ0UQHfIxYmKf0iW.0iYMcFytnECGrtOv1HDVhrBvEyKsBps16KToh1IrCbE=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

kc = LINE('Eu0CMtKUJxexZ3um6MT3.rQbq68XMQqTh/UyLzuFmuW.EblN4P68MeqsLwYo8TjNJ+ii9IxSpVwRpfFjugnBpqk=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

ke = LINE('Euv7BWCng6Zd6TB6hnNe.suxc3CYHYuNtF8LZD0ehhG.JuwDNCv0NSPGBeUglylI0zczOsx/XzAY0plJYPalzyk=')
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Timeline Token : " + str(ke.tl.channelAccessToken))

km = LINE('Eu1jsjHxCmvGR6yvNfmc.ovqvmfGzvKpMHoOPQ4Gpta.9M5P+9Xd/NULBuJxOcpwkWzDNCshL7nSxxsm0NC+r0s=')
km.log("Auth Token : " + str(km.authToken))
km.log("Timeline Token : " + str(km.tl.channelAccessToken))
...
RfuBot=[lineMID,kiMID,kkMID,keMID,kcMID,kmMID]
Family=["ub5abe828cd964292195c3c59d6322033",lineMID,kiMID,kkMID,kcMID,keMID,kmMID]
...
#==============================================================================#
                    ...
                    try:
                        ...
                        if strnum == "off":
                                ...
                                if settings["lang"] == "JP":
                                    line.sendText(msg.to,"ปิดใช้งานระบบยกเลิกเชิญอัตโนมัติแล้ว")
                                else:
                    ...
                    line.sendMessage(to, "ปิดระบบออกแชทรวมอัตโนมัติแล้ว")
                elif text.lower() == '.เปิดอ่าน':
                    settings["autoRead"] = True
                    line.sendMessage(to, "เปิดระบบอ่านข้อความอัตโนมัติ.")
                elif text.lower() == '.ปิดอ่าน':
                    settings["autoRead"] = False
                    line.sendMessage(to, "ปิดระบบอ่านข้อความอัตโนมัติแล้ว.")
                elif text.lower() == '.เปิดติ๊ก':
                    settings["checkSticker"] = True
                    line.sendMessage(to, "เช็คไอดีสติ๊กเกอร์ 👌")
                elif text.lower() == '.ปิดติ๊ก':
                    settings["checkSticker"] = False
                    line.sendMessage(to, "เช็คไอดีสติ๊กเกอร์ 🙅")			
                elif text.lower() == '.เปิดมุด':
                    settings["autoJoinTicket"] = True
                    line.sendMessage(to, "เปิดระบบมุดตามลิ้ง.")
                elif text.lower() == '.ปิดมุด':
                    settings["autoJoinTicket"] = False
                    line.sendMessage(to, "ปิดระบบมุดตามลิ้งแล้ว.")
...
#==============================================================================#
                    ...
                    ki.createGroup("RED SAMURAI SELFBOT", mi_d)
                    ki.sendText(msg.to,"welcome to room RED SAMURAI SELFBOT")
                    kk.createGroup("RED SAMURAI SELFBOT", mi_d)
                    kk.sendText(msg.to,"welcome to room RED SAMURAI SELFBOT")
                    ke.createGroup("RED SAMURAI SELFBOT", mi_d)
                    ke.sendText(msg.to,"welcome to room RED SAMURAI SELFBOT")
                    kc.createGroup("RED SAMURAI SELFBOT", mi_d)
                    kc.sendText(msg.to,"welcome to room RED SAMURAI SELFBOT")
                    km.createGroup("RED SAMURAI SELFBOT", mi_d)
                    km.sendText(msg.to,"welcome to room RED SAMURAI SELFBOT")
